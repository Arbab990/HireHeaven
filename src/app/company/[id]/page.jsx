...
const CompanyPage = () => {
  ...
  let companyJobs = jobs?.filter((job) => job.company === id);
  ...
  const addRef = useRef();
  const clickAdd = () => addRef.current.click();
              ...
              <Dialog>
                ...
                <DialogContent className="sm:max-w-[425px]">
                  <DialogHeader>
                    ...
                    <DialogDescription>
                      Please add valid job. If it is fake, we will take action.
                    </DialogDescription>
                  </DialogHeader>
                  <div className="grid gap-4 py-4">
                    ...
                    <div className="grid grid-cols-4 items-center gap-4" ref={ref}>
                      <Label>Location</Label>
                      <div className="col-span-3 relative">
                      <LocationInput location={location} setLocation={setlocation} />
                        {status === "OK" && (
                          <ul className="absolute z-10 bg-white dark:bg-gray-800 w-full shadow-lg rounded mt-1">
                            {data.map((suggestion) => (
                              <li
